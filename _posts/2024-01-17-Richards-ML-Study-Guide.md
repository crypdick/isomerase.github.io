...
https://www.youtube.com/playlist?list=PLBE9407EA64E2C318&index=1
...
### "Machine Learning Engineering for Production (MLOps)" by Andrew Ng

https://www.youtube.com/playlist?list=PLkDaE6sCZn6GMoA0wbpJLi3t34Gd8l0aK&index=1
...
There is a new version of the course ("Machine Learning Specialization"), but I haven't watched it yet. Here is the link: https://www.youtube.com/playlist?list=PLkDaE6sCZn6FNC6YRfRQc_FbeQrF8BwGI
...
There is an MIT course that is based on this talk: https://github.com/dcai-course/dcai-lab 

## Deep Learning

### "Neural networks" 3Blue1Brown playlist

https://www.youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi&index=1
...
https://www.youtube.com/watch?v=UOvPeC8WOt8&list=PLyPKqVSnetmEOp_g_hfabuRAs9ET-shl_
...
This playlist is a "hackers guide" to neural networks. It has an emphasis on coding everything from scratch in pure Python, so while the code is not the fastest it is compact, easy to read, and easy to understand. This is a great resource for learning how neural networks work under the hood end-to-end.
...
Alfredo Canziani also is currently writing a book on deep learning theory from an energy perspective. As of right now, it is not finished, but I am excited for it based on the sneak-peaks he has posted on Twitter. https://atcold.github.io/book.html
...
* Twitter. I find Twitter to be much better than Reddit for keeping up with the latest research.
